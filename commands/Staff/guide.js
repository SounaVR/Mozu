exports.run = async (client, message, args, getPlayer, getUser) => {
    ...
    **m!cheat [@user] [set/add] [data/enchant/items/prospect/ress/slots/stats] [colonne] [valeur]** : Modifie une donnée dans la database.
    ...
    **m!drop [@user]** : Owner only, supprimer __l'entièreté__ des données de la database de l'utilisateur mentionné.
